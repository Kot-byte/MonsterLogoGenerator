...
const baseMustacheSVG = `
    <svg class="swag mustache">
        <path fill="#020202" d="M255.8,345.9c-11.1-18.6-44.5,20.1-56.2-0.5c2.9,12.8,22.6,25.7,39.8,22c3.8-0.8,12.5-3.7,16.4-9.1
...
const shieldMustacheSVG = `
    <svg class="swag mustache">
        <path fill="#020202" d="M256.1,339.5c-12.1-20.4-48.8,22-61.7-0.5c3.2,14,24.8,28.2,43.6,24.1c4.2-0.9,13.7-4.1,18-10
...
const rhombusMustacheSVG = `
    <svg class="swag mustache">
        <path fill="#020202" d="M255.7,327.9c-9.5-15.9-38.2,17.2-48.3-0.4c2.5,11,19.4,22.1,34.2,18.9c3.3-0.7,10.7-3.2,14.1-7.8
...
const wreathMustacheSVG = `
    <svg class="swag mustache">
        <path fill="#020202" d="M256,331.2c-12.5-20.9-50,22.6-63.2-0.6c3.3,14.4,25.4,28.9,44.8,24.7c4.3-0.9,14.1-4.2,18.4-10.2
...
const crossMustachSVG = `
    <svg class="swag mustache">
        <path fill="#020202" d="M256,370.9c-11.9-20-47.8,21.6-60.4-0.5c3.2,13.8,24.3,27.7,42.8,23.6c4.1-0.9,13.4-4,17.7-9.8
